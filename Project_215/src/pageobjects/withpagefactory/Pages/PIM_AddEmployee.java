...
public class PIM_AddEmployee
{
		...
		@FindBy(xpath = "(//span[contains(.,'Required')])[1]")
		public WebElement fnameerrorlabel;
		...
		public boolean verifyFirstnamerrorLabelPresented()
		{
			boolean flag=fnameerrorlabel.getText().equals("Required");
			return flag;
		}
